/*
 * ports/picocalc_rp2350/port_config.h -- ClockworkPi PicoCalc RP2350
 ...
 * D1). PicoCalc keeps a 4 KiB smaller heap to fit the VM alongside the
 * full interpreter. */
#define HAL_PORT_HEAP_MEMORY_SIZE (296 * 1024)
