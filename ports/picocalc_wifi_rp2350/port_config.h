/*
 * ports/picocalc_wifi_rp2350/port_config.h -- ClockworkPi PicoCalc
 * Pico 2 W port-scoped compile-time constants.
 */
...
/* Pico 2 W claims the onboard LED for the CYW43 radio. */
/* Pico 2 W reserves GP29 for the CYW43 radio. */
#define HAL_PORT_ADC_CHANNEL_MAX 3

/* PicoCalc Pico 2 W runs lwIP + CYW43; the deleted hal_port_config.h kept GPIO
...
/* Stage-A palette flags (decascade plan). This port combines WiFi with
 * GUICONTROLS today (GUI.c references Option.MaxCtrls
...
/* core1stack[] size in words. PicoCalc Pico 2 W with SPI LCD uses core1 for the
 ...
 * D1). PicoCalc Pico 2 W has no USB-keyboard variant. */
#define HAL_PORT_HEAP_MEMORY_SIZE (200 * 1024)
/* PicoCalc Pico 2 W leaves extra SRAM headroom for WiFi, GUI controls,
