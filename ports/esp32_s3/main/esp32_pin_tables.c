...
const struct s_PinDef PinDef[NBRPINS + 1] = {
    ...
    ESP32_PWM_PIN(4, ESP32_ANALOG, 3, ESP32_PWM1B, ESP32_PWM_B(1)),
    ESP32_PWM_PIN(5, ESP32_ANALOG, 4, ESP32_PWM2A, ESP32_PWM_A(2)),
    ...
    ESP32_PWM_PIN(14, ESP32_ANALOG, 13, ESP32_PWM2B, ESP32_PWM_B(2)),
    ...
    ESP32_PWM_PIN(21, ESP32_DIGITAL, ESP32_ADC_NONE, ESP32_PWM1A, ESP32_PWM_A(1)),
    ESP32_UNUSED(22),
    ESP32_UNUSED(23),
    ESP32_UNUSED(24),
    ESP32_UNUSED(25),
    ...
    ESP32_PWM_PIN(42, ESP32_DIGITAL, ESP32_ADC_NONE, ESP32_PWM3B, ESP32_PWM_B(3)),
