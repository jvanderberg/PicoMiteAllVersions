/*
 * ports/picocalc_wifi_rp2040/port_config.h -- ClockworkPi PicoCalc
 * Pico W port-scoped compile-time constants.
 */
...
/* WiFi + PicoCalc board support is larger than the stock WebMite 1080 KB
 * option/program-flash boundary. Keep writable flash above the firmware. */
